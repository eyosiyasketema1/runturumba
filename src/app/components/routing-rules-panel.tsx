            ...
            <div className="shrink-0 h-14 border-b border-border bg-background flex items-center justify-between px-6 gap-4">
              <div className="flex items-center gap-3">
                ...
                >
                  ...
                  <span className="text-sm font-semibold">Back to Conversations</span>
                </button>
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar">
              <div className="max-w-5xl mx-auto px-6 py-6 space-y-5">
                ...
                {filteredRules.length === 0 ? (
                  <div className="flex flex-col items-center justify-center py-20 gap-4 text-center border border-dashed border-border bg-muted/10">
